...
class NavigatorUnNamedGetXPage extends StatelessWidget {
  const NavigatorUnNamedGetXPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
            ...
            child: const Text("Navigator Un named")),
      ),
    );
  }
}
